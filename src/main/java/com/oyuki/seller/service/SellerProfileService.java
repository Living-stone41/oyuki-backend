...
public class SellerProfileService {
    ...
    public SellerProfileResponse saveProfile(
        ...
        if (
            ...
            profile.setIdDocumentUrl(
                    request.idDocumentUrl().trim()
            );
        }
        ...
        if (
            ...
            profile.setBusinessDocumentUrl(
        ...
        if (
                hasText(
                        request.cacDocumentUrl()
                )
        ) {
            profile.setCacDocumentUrl(
                    request.cacDocumentUrl().trim()
            );
        }
    ...
    @Transactional
    public String uploadBusinessDocument(
            Long userId,
            MultipartFile file
    ) {
        getSeller(userId);
    ...
    @Transactional
    public String uploadCacDocument(
            Long userId,
            MultipartFile file
    ) {
        getSeller(userId);
    ...
    private SellerProfile getCompletedProfile(
            Long userId
    ) {
