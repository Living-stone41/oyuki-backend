...
(function () {
  ...
  const Auth = {
    ...
    require(role) {
      ...
      if (
        ...
        Toast.show(
          'You are not allowed to open this dashboard.',
          'error'
        );
  ...
  const ProviderOrders = {
    ...
    accept(id) {
      return Api.patch(
        `/orders/provider/items/${id}/accept`,
        {}
      );
    },
    ...
    reject(id, reason) {
      return Api.patch(
        `/orders/provider/items/${id}/reject`,
        { reason }
      );
    },
    ...
    processing(id) {
      return Api.patch(
        `/orders/provider/items/${id}/processing`,
        {}
      );
    },
    ...
    ready(id) {
      return Api.patch(
        `/orders/provider/items/${id}/ready`,
        {}
      );
    }
  };
  ...
  const AdminOrders = {
    ...
    markReceived(itemId) {
      return Api.patch(
        `/admin/orders/items/${itemId}/received`,
        {}
      );
    }
  };
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a
                class="dropdown-item"
                href="#"
                onclick="Oyuki.Auth.logout(); return false;"
              >
                Log out
              </a>
            </li>
